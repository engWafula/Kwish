      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Our Service</h2>
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            {/* 2nd testimonial */}
            <div className="group flex flex-col h-full p-6 bg-gray-800 border border-transparent hover:border-purple-600 rounded-lg transition-all" data-aos="fade-up" data-aos-delay="200">
              <div>
                <div className="relative inline-flex flex-col mb-4">
                  <BsWallet2 size={30} />
                  <h3 className="text-lg text-purple-600 mt-4">Kwish Wallet</h3>
                </div>
              </div>
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="#0">Learn More</a>
              </div>
            </div>
            ...
            <div className="group flex flex-col h-full p-6 bg-gray-800 border border-transparent hover:border-purple-600 rounded-lg transition-all" data-aos="fade-up" data-aos-delay="200">
              <div>
                <div className="relative inline-flex flex-col mb-4">
                  ...
                  <h3 className="text-lg text-purple-600 mt-4">Virtual Cards</h3>
                </div>
              </div>
              <blockquote className="text-lg text-gray-400 grow">
            ...
            <div className="group flex flex-col h-full p-6 bg-gray-800 border border-transparent hover:border-purple-600 rounded-lg transition-all" data-aos="fade-up" data-aos-delay="200">
              <div>
                <div className="relative inline-flex flex-col mb-4">
                  ...
                  <h3 className="text-lg text-purple-600 mt-4">Loans</h3>
                </div>
              </div>
              <blockquote className="text-lg text-gray-400 grow">
...
income earners in dire times.
            ...
            {/* <div className="group flex flex-col h-full p-6 bg-gray-800 border border-transparent hover:border-purple-600 rounded-lg transition-all" data-aos="fade-up" data-aos-delay="200">
              <div>
                <div className="relative inline-flex flex-col mb-4">
                  <GiTakeMyMoney size={30} />
                  <h3 className="text-lg text-purple-600 mt-4">Money Remittance</h3>
                </div>
              </div>
              <blockquote className="text-lg text-gray-400 grow">
              With interest as low as 9%, Kwish Cash provides aDue to EAC regulations, it has since taken local and
